...
namespace Smartstore.StrubeExport.Models
{
    public class OrderDetail
    {
        ...
        public OrderDetail(OrderItem orderItem, ProfileConfigurationModel _config,IEncryptor encryptionService=null,string encryptionKey="")
        {
            this.Id = orderItem.Order.OrderGuid.ToString();
            //this.OrderId = orderItem.Order.GetOrderNumber();
            this.OrderId = orderItem.Order.OrderNumber;
